...
class MyMapDataset(Dataset):
    def __init__(self, dataset, tokenizer, token_length, DEVICE, mode):
        if dataset == 'essays':
            datafile = '/Users/johnfields/Documents/GitHub/personality-prediction/data/essays/essays.csv'
            author_ids, input_ids, targets = dataset_processors.essays_embeddings(datafile, tokenizer, token_length, mode)
        elif dataset == 'kaggle':
            datafile = '/Users/johnfields/Documents/GitHub/personality-prediction/data/kaggle/kaggle.csv'
